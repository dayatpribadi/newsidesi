(function() {
    ...
    // Trezo Tabs
    const trezoTabsMainID = document.getElementById("trezo-tabs-main");
    if (trezoTabsMainID) {
        document.addEventListener("DOMContentLoaded", function() {
            // Function to handle tab switching for each tab group
            function setupTabs() {
                const tabGroups = document.querySelectorAll('.trezo-tabs-main');
                tabGroups.forEach((group) => {
                    ...
                    tabs.forEach(tab => {
                        tab.addEventListener("click", function() {
                            ...
                            const contentId = tab.getAttribute("data-tab-main");
    ...
    // Trezo Tabs
    const trezoTabsID = document.getElementById("trezo-tabs-nested");
    if (trezoTabsID) {
        document.addEventListener("DOMContentLoaded", function() {
            // Function to handle tab switching for each tab group
            function setupTabs() {
                const tabGroups = document.querySelectorAll('.trezo-tabs-nested');
                tabGroups.forEach((group) => {
                    const tabs = group.querySelectorAll(".nav-link");
                    const contents = group.querySelectorAll(".tab-pane");
                    tabs.forEach(tab => {
